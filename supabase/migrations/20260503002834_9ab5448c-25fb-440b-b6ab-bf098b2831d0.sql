...
DROP TRIGGER IF EXISTS prevent_lesson_overlap_before_save ON public.lessons;
CREATE TRIGGER prevent_lesson_overlap_before_save
BEFORE INSERT OR UPDATE OF scheduled_at, duration_minutes, status
ON public.lessons
FOR EACH ROW
EXECUTE FUNCTION public.prevent_lesson_overlap();